    ...
    return (
      <div>
          <Switch>
            ...
            <Route path="/matchmaker" component={(props) => (
              <Protected component={MatchMaker} {...props} />
            )}/>
            <Route path="/follows" component={(props) => (
              <Protected component={Follows} {...props} />
            )} />
            <Route path="/mymatch" component={(props) => (
              <Protected component={MyMatch} {...props} />
            )} />
            <Route path="/leaderboard" component={(props) => (
              <Protected component={Leaderboard} {...props} />
            )} />
            <Route path="/account/:page(tags)/:tagtype(user|pref)" component={(props) => (
              <Protected component={Account} {...props} />
            )} />
            <Route path="/account/:page(bio|photoupload)" component={(props) => (
              <Protected component={Account} {...props} />
            )} />
