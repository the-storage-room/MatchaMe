...
export const findCoordinatesAndCalculateDistance = async (zipcode1, zipcode2) => {
	let user1Lat;
	let user1Lng;
	let user2Lat;
	let user2Lng;
	const { API_KEY } = process.env;
	const data = await fs.readFileAsync(__dirname + '/zipcodesAndGeocodes.js', 'utf-8');
	try {
